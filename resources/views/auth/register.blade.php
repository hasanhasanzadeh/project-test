            ...
            <div class="max-w-md w-full p-6">
                ...
                <form action="{{route('register')}}" method="POST" class="space-y-4">
                    ...
                    <div x-data="{ show: true }">
                        ...
                        <div class="relative">
                            <input name="password" placeholder="کلمه عبور (حداقل ۶ حرف)" :type="show ? 'password' : 'text'" class="w-full px-3 py-2 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        <label for="referral_code" class="block font-medium text-gray-700 dark:text-gray-200 p-1">کد معرف</label>
                        <input type="text" id="referral_code" value="{{request('referral_code')}}" name="referral_code" placeholder="کد معرف (اختیاری)" class="w-full px-3 py-2 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500" maxlength="20">
                    </div>
                    ...
                    <div>
                        <p class="text-sm font-vazir text-center">
                             با عضویت در {{$title}}
                            <a href="{{route('provision.index')}}" class="text-blue-600 hover:text-white dark:hover:text-blue-500">قوانین و مقررات</a>
                            <span>
                                میپذیرم
                            </span>
                        </p>
                    ...
                    <div>
                        <button type="submit" class="w-full bg-blue-400 text-dark p-2 dark:text-black rounded-md hover:bg-blue-600 focus:outline-none focus:bg-black focus:text-white focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 transition-colors duration-300 my-2">
                            <span class="px-2">مرحله بعد</span>
                    ...
                    <div>
                        <div class="p-2 text-center">
                            <a href="{{route('login')}}" class="dark:text-white hover:text-blue-600 text-dark dark:hover:text-blue-500">
                                قبلا عضو بوده ام!
                            </a>
                        </div>
                    </div>
