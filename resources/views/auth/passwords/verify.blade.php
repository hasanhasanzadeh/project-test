...
@section('content')
    ...
    <div class="flex h-screen">
                ...
                <div class="block items-center justify-center">
                    ...
                    <p class="text-sm font-semibold mb-6 text-black text-center dark:text-stone-100">
                        ...
                        <?php
                            ...
                            ?>
                        <span class="text-yellow-600 px-2">{{request()->session()->get('auth')['mobile']??request()->session()->get('mobile')}}</span>
                        پیامک شد
                    </p>
                </div>
                <form action="{{route('password.verify_otp')}}" method="post" dir="ltr" class="text-center" autocomplete="off" id="validate">
                    @csrf
                    <input type="hidden" name="mobile" value="{{request()->session()->get('auth')['mobile']??request()->session()->get('mobile')}}">
        ...
        <!-- Left Pane -->
        <div class="hidden lg:flex items-center justify-center flex-1 bg-blue-400 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
            <div class="max-w-md text-center">
                ...
                <br>
                <p class="p-2 text-2xl font-vazir font-weight-bold dark:text-white">
                    {{$title}}
                </p>
            </div>
        </div>
