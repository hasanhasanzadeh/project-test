            ...
            <div class="max-w-md w-full p-6">
                <div class="block items-center justify-center">
                    ...
                    <p class="text-sm font-semibold mb-6 text-black text-center dark:text-stone-100">
                        بازنشانی کلمه عبور موبایل
                        <span class="text-blue-600 px-2">{{request()->session()->get('auth')['mobile']??request()->session()->get('mobile')}}</span>
                    </p>
                </div>
                <div class="mx-auto space-y-6">
                    <form action="{{route('password.reset')}}" method="POST" autocomplete="off" id="validate">
                        @csrf
