        ...
        <div class="w-full bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-md w-full p-6">
                ...
                <form action="#" method="POST" class="space-y-4">
                    ...
                    <div>
                        <button type="submit" class="w-full bg-yellow-400 text-dark p-2 dark:text-black rounded-md hover:bg-yellow-600 focus:outline-none focus:bg-black focus:text-white focus:ring-2 focus:ring-offset-2 focus:ring-yellow-600 transition-colors duration-300">Sign Up</button>
                    </div>
                </form>
            </div>
        </div>
