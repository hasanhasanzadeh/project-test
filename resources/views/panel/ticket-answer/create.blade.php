...
@section('content')
    <div class="container px-6 mx-auto grid">
        ...
        <div class="flex justify-between gap-4">
            <div>
                <a href="{{route('tickets.index')}}" class="bg-yellow-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-auto">
            ...
            @if($ticket->status!='closed')
                <div>
                    <a href="{{route('tickets.close',$ticket->id)}}" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mr-auto">
        ...
        <div class="w-full shadow-lg rounded bg-yellow-600 text-white my-4">
            <div x-data="accordion(1)" class="relative transition-all duration-700">
                ...
                <div x-ref="tab" :style="handleToggle()" class="relative overflow-hidden transition-all duration-700 max-h-0 bg-gray-100 dark:bg-gray-700">
                    <div class="px-6 pb-4 text-gray-700 dark:text-gray-200">
                        ...
                        <form method="post" class="p-2 m-2 md:p-5 md:m-5" action="{{route('answers.store',$ticket->id)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="flex flex-wrap mx-3 mb-6">
                                ...
                                <div class="w-full px-3  my-3">
                                    <button type="submit" class="d-block bg-yellow-600 hover:bg-yellow-700 text-gray-200 font-bold py-2 px-4 rounded">
                            ...
                            @if($answer->attach)
                                <h6 class="text-left ">
                                    ...
                                    <a href="{{$answer->attach->address}}" class="px-2 mx-auto" title="دانلود فایل ضمیمه">
                                        <i class="fa fa-download text-yellow-600 hover:text-yellow-700 text-2xl"></i>
                                    </a>
                                </h6>
                            @endif
                        </div>
