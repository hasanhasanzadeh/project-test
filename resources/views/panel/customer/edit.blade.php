                ...
                <form class="w-full" method="post" action="{{route('customers.update',$customer->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap mx-3 my-2">
                        <div class="w-full md:w-1/2 px-3 my-3">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="name" name="name" type="text" value="{{$customer->name}}" placeholder="{{__('dashboard.name')}}">
                        </div>
                        <div class="w-full md:w-1/2 px-3 my-3">
