    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs border" >
            <div class="w-full overflow-x-auto">
                <form class="w-full" method="post" action="{{route('notifies.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="flex flex-wrap mx-3 mb-6">
                        ...
                        <div class="w-full md:w-1/2 px-3 my-3">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="expired_at" name="expired_at" type="date" value="{{old('expired_at')}}" placeholder="{{__('dashboard.expired_at')}}">
                        </div>
                        <div class="w-full md:w-1/2 px-3  my-3">
                        ...
                        <div class="w-full md:w-1/2 px-3  my-3">
                            ...
                            <select name="type" id="type" class="form-select appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-14 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                ...
                                <option value="some">{{__('dashboard.some')}}</option>
                            </select>
                        </div>
