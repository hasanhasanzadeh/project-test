                        ...
                        @foreach($symbols as $symbol)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    ...
                                    @else
                                        <img src="{{url('/images/no-image.png')}}" height="100" width="100" alt="" class="rounded-full mx-auto">
                                    @endif
                                </td>
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <a href="{{route('symbols.edit',$symbol->id)}}" class="text-yellow-400 mx-auto" title="{{__('dashboard.edit')}}">
                                        ...
                                        <form action="{{route('symbols.destroy',$symbol->id)}}" method="POST" class="mx-auto">
                                            @csrf
                                            {{method_field('DELETE')}}
