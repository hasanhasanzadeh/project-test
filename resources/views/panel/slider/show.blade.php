        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs border" >
            <table class="w-full  order">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm">
                        <img src="{{$slider->photo->address??url('/images/no-image.png')}}" height="100" width="100" alt="" class="rounded mx-auto">
                    </td>
                </tr>
                <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">{{__('dashboard.photo')}}</td>
                    <td class="px-4 py-3 text-sm">
                        <img src="{{$slider->image->address??url('/images/no-image.png')}}" height="100" width="100" alt="" class="rounded mx-auto">
                    </td>
                </tr>
                <tr class="text-gray-700 dark:text-gray-400">
