...
@section('content')
    <div class="container px-6 mx-auto grid">
        ...
        <a href="{{route('user-levels.index')}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-auto">
            ...
            {{__('dashboard.user-levels')}}
        </a>
        <!-- New Table -->
        <div class="w-full overflow-hidden rounded-lg shadow-xs border" >
            <div class="w-full overflow-x-auto">
                <form class="w-full" method="post" action="{{route('user-levels.update',$userLevel->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="flex flex-wrap mx-3 mb-6">
                        <div class="w-full px-3 my-3">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="level_name" name="level_name" type="text" value="{{$userLevel->level_name}}" placeholder="{{__('dashboard.level_name')}}">
                        </div>
                        <div class="w-full md:w-1/2 px-3 my-3">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="level_number" name="level_number" type="number" min="1" max="9" maxlength="1" value="{{$userLevel->level_number}}" placeholder="{{__('dashboard.level_number')}}">
                        </div>
                        <div class="w-full md:w-1/2 px-3 my-3">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 dark:text-gray-50" for="wage">
                                {{__('dashboard.wage')}}
                            </label>
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="wage" name="wage" type="number" maxlength="6" value="{{$userLevel->wage}}" placeholder="{{__('dashboard.wage')}}">
                        </div>
                        <div class="w-full px-3 my-3">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="maximum_deposit" name="maximum_deposit" type="text"  value="{{$userLevel->maximum_deposit}}" placeholder="{{__('dashboard.maximum_deposit')}}">
                        </div>
                        <div class="w-full px-3 my-3">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="maximum_withdrawal" name="maximum_withdrawal" type="text"  value="{{$userLevel->maximum_withdrawal}}" placeholder="{{__('dashboard.maximum_withdrawal')}}">
                        </div>
                    <div class="w-full px-3 my-3">
                        ...
                        <img id="image-select" alt="" src="{{$userLevel->photo->address??''}}" class="object-cover shadow rounded" width="150" height="150">
                    </div>
                        <div class="w-full px-3  my-3">
                            ...
                            <textarea name="description" class="form-textarea appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="{{__('dashboard.enterDescription')}}" id="description" cols="30" rows="10">{!!$userLevel->description!!}</textarea>
                        </div>
                    <div class="w-full px-3  my-3">
