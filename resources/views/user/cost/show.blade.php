                    ...
                    <div class="mx-auto w-full">
                        @if(!$cost)
                            ...
                            <div class="text-center flex justify-center items-center">
                                <span class="text-2xl text-gray-700 dark:text-gray-200 font-bold">درخواست شما یافت نشد</span>
                            </div>
                        @elseif($cost->status==='accept')
                            ...
                            <div class="text-center flex justify-center items-center">
                                <span class="text-2xl text-gray-700 dark:text-gray-200 font-bold">درخواست مشا تایید شد و میتوانید پرداخت خود را انجام دهید</span>
                            </div>
                            <form id="paymentForm">
                        ...
                        @elseif($cost->status==='pending')
                            ...
                            <div class="text-center flex justify-center items-center">
                                <span class="text-2xl text-gray-700 dark:text-gray-200 font-bold">درخواست شما در حال پردازش می باشد</span>
                            </div>
                        @elseif($cost->status==='cancel')
                            ...
                            <div class="text-center flex justify-center items-center">
                                <span class="text-2xl text-gray-700 dark:text-gray-200 font-bold">درخواست پرداخت شما لغو شد </span>
                            </div>
                        @elseif($cost->status==='fail')
                            ...
                            <div class="text-center flex justify-center items-center">
                                <span class="text-2xl text-gray-700 dark:text-gray-200 font-bold">پرداخت شما ناموفق بود</span>
                            </div>
                        @elseif($cost->status==='done')
                            ...
                            <div class="text-center flex justify-center items-center">
                                <span class="text-2xl text-gray-700 dark:text-gray-200 font-bold">پرداخت شما با موفقیت انجام شد</span>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            $('#paymentForm').submit(function(event) {
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({
                        ...
                        national_code: {{$cost->user->national_code}}
                    }),
